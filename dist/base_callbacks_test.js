...
describe('BaseLogger Callback', function () {
    it('Records and averages losses in an epoch', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    baseLogger = new base_callbacks_1.BaseLogger();
                    baseLogger.setParams({ metrics: ['loss', 'val_loss'] });
                    return [4, baseLogger.onTrainBegin()];
                case 1:
                    _a.sent();
    ...
    it('Forgets old epochs', function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 7:
                    ++i;
                    return [3, 2];
                case 8: return [4, baseLogger.onEpochBegin(numOldEpochs)];
                case 9:
                    _a.sent();
                    return [4, baseLogger.onBatchBegin(0)];
                case 10:
...
describe('CallbackList', function () {
    it('Constructor with empty arg', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    callbackList = new base_callbacks_1.CallbackList();
    ...
    it('Constructor and setParams with array of callbacks', function () {
        var history1 = new base_callbacks_1.History();
        var history2 = new base_callbacks_1.History();
        var callbackList = new base_callbacks_1.CallbackList([history1, history2]);
    ...
    it('onTrainBegin', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history1 = new base_callbacks_1.History();
                    history2 = new base_callbacks_1.History();
                    callbackList = new base_callbacks_1.CallbackList([history1, history2]);
                    return [4, callbackList.onTrainBegin()];
                case 1:
                    _a.sent();
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history1 = new base_callbacks_1.History();
                    history2 = new base_callbacks_1.History();
                    callbackList = new base_callbacks_1.CallbackList([history1]);
                    return [4, callbackList.onTrainBegin()];
                case 1:
                    _a.sent();
                    expect(history1.epoch).toEqual([]);
...
test_utils_1.describeMathCPUAndGPU('resolveScalarsInLogs', function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    logs = {
                        'a': 1,
                        'b': tfjs_core_1.scalar(2),
                        'c': -3,
                        'd': tfjs_core_1.scalar(-4),
                    };
...
test_utils_1.describeMathCPUAndGPU('disposeTensorsInLogs', function () {
    it('Resolve mixed numbers and scalars', function () {
        ...
        logs_1.disposeTensorsInLogs(logs);
        expect(logs['a']).toEqual(1);
...
describe('History Callback', function () {
    it('onTrainBegin', function (done) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    history = new base_callbacks_1.History();
...
var MockCallback = (function (_super) {
    __extends(MockCallback, _super);
    function MockCallback() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return MockCallback;
}(callbacks_1.Callback));
describe('CallbackList', function () {
    it('Constructor and setModel with array of callbacks', function () {
        var mockCallback1 = new MockCallback();
        var mockCallback2 = new MockCallback();
        var callbackList = new base_callbacks_1.CallbackList([mockCallback1, mockCallback2]);
...
//# sourceMappingURL=base_callbacks_test.js.map