...
var pooling_1 = require("./pooling");
test_utils_1.describeMathCPUAndGPU('pool2d', function () {
    var x4by4Data = [[[
        ...
        var _loop_2 = function (dataFormat) {
            var _loop_3 = function (stride) {
                ...
                it(testTitle, function () {
                    ...
                    if (poolMode === 'avg') {
                        if (stride === 1) {
                            yExpected = tfjs_core_1.tensor4d([[[
                                        [25, 45, 65, 75], [5, 5, 5, 5], [-25, -45, -65, -75],
                                        [-30, -50, -70, -80]
                                    ]]], [1, 1, 4, 4]);
                        }
                        else {
                            yExpected = tfjs_core_1.tensor4d([[[[25, 65], [-25, -65]]]], [1, 1, 2, 2]);
                        }
                    }
                    else {
                        if (stride === 1) {
                            ...
                            yExpected = tfjs_core_1.tensor4d([[[[40, 80], [-10, -50]]]], [1, 1, 2, 2]);
                        }
                    }
                    if (dataFormat !== 'channelsFirst') {
                        yExpected = tfc.transpose(yExpected, [0, 2, 3, 1]);
                    }
                    var y = pooling_1.pool2d(x, [2, 2], [stride, stride], 'same', dataFormat, poolMode);
    ...
    var _loop_4 = function (poolMode) {
        it("5x5, 2, same, CHANNEL_FIRST, " + poolMode, function () {
            var x5by5 = tfjs_core_1.tensor4d(x5by5Data, [1, 1, 5, 5]);
            var yExpected = tfjs_core_1.tensor4d(x4by4Data, [1, 1, 4, 4]);
            if (poolMode === 'avg') {
                yExpected = tfjs_core_1.tensor4d([[[[0.75, 4.5, 7.5], [-0.25, -2, -3.5], [-1, -5, -8]]]], [1, 1, 3, 3]);
            }
            else {
                yExpected =
                    tfjs_core_1.tensor4d([[[[2, 6, 8], [0, 0, 0], [0, -4, -8]]]], [1, 1, 3, 3]);
            }
            var y = pooling_1.pool2d(x5by5, [2, 2], [2, 2], 'same', 'channelsFirst', poolMode);
            test_utils_1.expectTensorsClose(y, yExpected);
        });
    };
    ...
    var _loop_5 = function (poolMode) {
        it("5x5, 2, valid, CHANNEL_LAST, " + poolMode, function () {
            var x5by5 = tfc.transpose(tfjs_core_1.tensor4d(x5by5Data, [1, 1, 5, 5]), [0, 2, 3, 1]);
            var yExpected;
            if (poolMode === 'avg') {
                yExpected = tfjs_core_1.tensor4d([[[[0.75, 4.5], [-0.25, -2]]]], [1, 1, 2, 2]);
            }
            else {
                yExpected = tfjs_core_1.tensor4d([[[[2, 6], [0, 0]]]], [1, 1, 2, 2]);
            }
            var y = pooling_1.pool2d(x5by5, [2, 2], [2, 2], 'valid', 'channelsLast', poolMode);
            test_utils_1.expectTensorsClose(y, tfc.transpose(yExpected, [0, 2, 3, 1]));
        });
    };
            ...
            var _loop_8 = function (poolSize) {
                var _loop_9 = function (strides) {
                    ...
                    it(testTitle, function () {
                        ...
                        var symbolicInput = new topology_1.SymbolicTensor('float32', inputShape, null, [], null);
                        ...
                        var expectedOutputLength = conv_utils_1.convOutputLength(inputLength, poolSize, paddingMode, strides ? strides : poolSize);
...
test_utils_1.describeMathCPUAndGPU('Pooling Layers 1D: Tensor', function () {
    var poolModes = ['avg', 'max'];
    var strides = [2, 4];
    var poolSizes = [2, 4];
    var batchSize = 2;
        ...
        var _loop_11 = function (stride) {
            var _loop_12 = function (poolSize) {
                var testTitle = "stride=" + stride + ", " + poolMode + ", " +
                    ("poolSize=" + poolSize);
                it(testTitle, function () {
                    var x2by8 = tfjs_core_1.tensor2d([
                    ...
                    test_utils_1.expectTensorsClose(output, tfjs_core_1.tensor3d(expectedOutputVals, expectedShape));
                });
            };
            ...
            var _loop_21 = function (batchSize) {
                var _loop_22 = function (channels) {
                    ...
                    it(testTitle, function () {
                        ...
                        var x4by4 = tfjs_core_1.tensor4d(xArrayData, [batchSize, channels, 4, 4]);
                        var poolConstructor = poolMode === 'avg' ?
                            tfl.layers.averagePooling2d :
                            tfl.layers.maxPooling2d;
                        var poolingLayer = poolConstructor({
                        ...
                        test_utils_1.expectTensorsClose(output, tfjs_core_1.tensor4d(expectedOutputArray, expectedShape));
                    });
                };
    ...
    var _loop_24 = function (globalPoolingLayer) {
        ...
        it(testTitle, function () {
            ...
            if (globalPoolingLayer === tfl.layers.globalAveragePooling1d) {
                expectedOutput = tfjs_core_1.tensor2d([[11, -8.25], [-11, 8.25]], [2, 2]);
            }
            else {
                expectedOutput = tfjs_core_1.tensor2d([[40, -1], [0, 20]], [2, 2]);
            }
        ...
        var _loop_28 = function (dataFormat) {
            ...
            it(testTitle, function () {
                ...
                if (globalPoolingLayer === tfl.layers.globalAveragePooling2d) {
                    if (dataFormat === 'channelsFirst') {
                        expectedOutput = tfjs_core_1.tensor2d([[0.25, 2.5], [0.25, 2.5]], [2, 2]);
                    }
                    else {
                        expectedOutput = tfjs_core_1.tensor2d([[11, -8.25], [11, -8.25]], [2, 2]);
                    }
                    ...
                    if (dataFormat === 'channelsFirst') {
                        expectedOutput = tfjs_core_1.tensor2d([[4, 40], [4, 40]], [2, 2]);
                    }
                    else {
                        expectedOutput = tfjs_core_1.tensor2d([[40, -1], [40, -1]], [2, 2]);
                    }
                }
                test_utils_1.expectTensorsClose(output, expectedOutput);
